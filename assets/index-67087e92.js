var ie=Object.defineProperty;var re=(e,t,n)=>t in e?ie(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var E=(e,t,n)=>(re(e,typeof t!="symbol"?t+"":t,n),n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function n(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(r){if(r.ep)return;r.ep=!0;const l=n(r);fetch(r.href,l)}})();function k(){}function U(e){return e()}function B(){return Object.create(null)}function j(e){e.forEach(U)}function R(e){return typeof e=="function"}function F(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function se(e){return Object.keys(e).length===0}function m(e,t){e.appendChild(t)}function O(e,t,n){e.insertBefore(t,n||null)}function G(e){e.parentNode&&e.parentNode.removeChild(e)}function J(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}function g(e){return document.createElement(e)}function L(e){return document.createTextNode(e)}function Z(){return L(" ")}function le(e,t,n,a){return e.addEventListener(t,n,a),()=>e.removeEventListener(t,n,a)}function w(e,t,n){n==null?e.removeAttribute(t):e.getAttribute(t)!==n&&e.setAttribute(t,n)}function de(e){return Array.from(e.childNodes)}function K(e,t){t=""+t,e.data!==t&&(e.data=t)}let $;function _(e){$=e}function ue(){if(!$)throw new Error("Function called outside component initialization");return $}function he(e){ue().$$.on_mount.push(e)}const I=[],M=[];let T=[];const z=[],ce=Promise.resolve();let H=!1;function fe(){H||(H=!0,ce.then(V))}function P(e){T.push(e)}const Y=new Set;let b=0;function V(){if(b!==0)return;const e=$;do{try{for(;b<I.length;){const t=I[b];b++,_(t),pe(t.$$)}}catch(t){throw I.length=0,b=0,t}for(_(null),I.length=0,b=0;M.length;)M.pop()();for(let t=0;t<T.length;t+=1){const n=T[t];Y.has(n)||(Y.add(n),n())}T.length=0}while(I.length);for(;z.length;)z.pop()();H=!1,Y.clear(),_(e)}function pe(e){if(e.fragment!==null){e.update(),j(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(P)}}function me(e){const t=[],n=[];T.forEach(a=>e.indexOf(a)===-1?t.push(a):n.push(a)),n.forEach(a=>a()),T=t}const S=new Set;let v;function Q(){v={r:0,c:[],p:v}}function ee(){v.r||j(v.c),v=v.p}function y(e,t){e&&e.i&&(S.delete(e),e.i(t))}function x(e,t,n,a){if(e&&e.o){if(S.has(e))return;S.add(e),v.c.push(()=>{S.delete(e),a&&(n&&e.d(1),a())}),e.o(t)}else a&&a()}function A(e){return(e==null?void 0:e.length)!==void 0?e:Array.from(e)}function ge(e){e&&e.c()}function te(e,t,n){const{fragment:a,after_update:r}=e.$$;a&&a.m(t,n),P(()=>{const l=e.$$.on_mount.map(U).filter(R);e.$$.on_destroy?e.$$.on_destroy.push(...l):j(l),e.$$.on_mount=[]}),r.forEach(P)}function ne(e,t){const n=e.$$;n.fragment!==null&&(me(n.after_update),j(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function ye(e,t){e.$$.dirty[0]===-1&&(I.push(e),fe(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function oe(e,t,n,a,r,l,d,f=[-1]){const s=$;_(e);const i=e.$$={fragment:null,ctx:[],props:l,update:k,not_equal:r,bound:B(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(s?s.$$.context:[])),callbacks:B(),dirty:f,skip_bound:!1,root:t.target||s.$$.root};d&&d(i.root);let o=!1;if(i.ctx=n?n(e,t.props||{},(h,u,...p)=>{const c=p.length?p[0]:u;return i.ctx&&r(i.ctx[h],i.ctx[h]=c)&&(!i.skip_bound&&i.bound[h]&&i.bound[h](c),o&&ye(e,h)),u}):[],i.update(),o=!0,j(i.before_update),i.fragment=a?a(i.ctx):!1,t.target){if(t.hydrate){const h=de(t.target);i.fragment&&i.fragment.l(h),h.forEach(G)}else i.fragment&&i.fragment.c();t.intro&&y(e.$$.fragment),te(e,t.target,t.anchor),V()}_(s)}class ae{constructor(){E(this,"$$");E(this,"$$set")}$destroy(){ne(this,1),this.$destroy=k}$on(t,n){if(!R(n))return k;const a=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return a.push(n),()=>{const r=a.indexOf(n);r!==-1&&a.splice(r,1)}}$set(t){this.$$set&&!se(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const ve="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(ve);function C(e){let t;return{c(){t=g("span"),t.textContent="(click to show)",w(t,"id","showTxt"),w(t,"class","svelte-18crzc0")},m(n,a){O(n,t,a)},d(n){n&&G(t)}}}function we(e){let t,n,a,r,l,d,f,s,i,o=!e[1]&&C();return{c(){t=g("div"),n=g("div"),n.textContent=`${e[3]}`,a=Z(),r=g("div"),l=L(e[2]),d=Z(),o&&o.c(),w(n,"class","date svelte-18crzc0"),w(t,"class",f="post "+(e[0].thread?"thread":"")+" svelte-18crzc0")},m(h,u){O(h,t,u),m(t,n),m(t,a),m(t,r),m(r,l),m(r,d),o&&o.m(r,null),s||(i=le(t,"click",e[4]),s=!0)},p(h,[u]){u&4&&K(l,h[2]),h[1]?o&&(o.d(1),o=null):o||(o=C(),o.c(),o.m(r,null)),u&1&&f!==(f="post "+(h[0].thread?"thread":"")+" svelte-18crzc0")&&w(t,"class",f)},i:k,o:k,d(h){h&&G(t),o&&o.d(),s=!1,i()}}}function be(e,t,n){let{post:a}=t,r=new Intl.DateTimeFormat("en-US",{timeStyle:"short"}).format(new Date(a.date)),l=!1,f=a.post.split(" ").map(i=>{let o="blah".split("").map(h=>Math.floor(Math.random()*20)>10?h.toUpperCase():h).join("");for(let h=0;h<Math.floor(i.length/4);h++)o+=o;return i.includes("...")?o+"...":i.includes(".")?o+".":i.includes("?")?o+"?":i.includes("!")?o+"!":o}).join(" ");function s(){n(2,f=a.post),n(1,l=!0)}return e.$$set=i=>{"post"in i&&n(0,a=i.post)},[a,l,f,r,s]}class Ie extends ae{constructor(t){super(),oe(this,t,be,we,F,{post:0})}}const Te=`[
    {
...
`;function X(e,t,n){const a=e.slice();return a[3]=t[n],a}function D(e,t,n){const a=e.slice();return a[6]=t[n],a}function W(e){let t,n;return t=new Ie({props:{post:e[6]}}),{c(){ge(t.$$.fragment)},m(a,r){te(t,a,r),n=!0},p(a,r){const l={};r&1&&(l.post=a[6]),t.$set(l)},i(a){n||(y(t.$$.fragment,a),n=!0)},o(a){x(t.$$.fragment,a),n=!1},d(a){ne(t,a)}}}function q(e){let t,n,a,r=e[3][0].date.split(",")[0]+"",l,d,f,s,i=A(e[3]),o=[];for(let u=0;u<i.length;u+=1)o[u]=W(D(e,i,u));const h=u=>x(o[u],1,1,()=>{o[u]=null});return{c(){t=g("div"),n=g("div"),a=g("span"),l=L(r),d=Z();for(let u=0;u<o.length;u+=1)o[u].c();f=Z(),w(a,"class","svelte-bqs5vh"),w(n,"class","dateGroup svelte-bqs5vh")},m(u,p){O(u,t,p),m(t,n),m(n,a),m(a,l),m(t,d);for(let c=0;c<o.length;c+=1)o[c]&&o[c].m(t,null);m(t,f),s=!0},p(u,p){if((!s||p&1)&&r!==(r=u[3][0].date.split(",")[0]+"")&&K(l,r),p&1){i=A(u[3]);let c;for(c=0;c<i.length;c+=1){const N=D(u,i,c);o[c]?(o[c].p(N,p),y(o[c],1)):(o[c]=W(N),o[c].c(),y(o[c],1),o[c].m(t,f))}for(Q(),c=i.length;c<o.length;c+=1)h(c);ee()}},i(u){if(!s){for(let p=0;p<i.length;p+=1)y(o[p]);s=!0}},o(u){o=o.filter(Boolean);for(let p=0;p<o.length;p+=1)x(o[p]);s=!1},d(u){u&&G(t),J(o,u)}}}function _e(e){let t,n,a,r,l=A(e[0].reverse()),d=[];for(let s=0;s<l.length;s+=1)d[s]=q(X(e,l,s));const f=s=>x(d[s],1,1,()=>{d[s]=null});return{c(){t=g("main"),n=g("h1"),n.innerHTML='ar<span id="x" class="svelte-bqs5vh">X</span>iv',a=Z();for(let s=0;s<d.length;s+=1)d[s].c()},m(s,i){O(s,t,i),m(t,n),m(t,a);for(let o=0;o<d.length;o+=1)d[o]&&d[o].m(t,null);r=!0},p(s,[i]){if(i&1){l=A(s[0].reverse());let o;for(o=0;o<l.length;o+=1){const h=X(s,l,o);d[o]?(d[o].p(h,i),y(d[o],1)):(d[o]=q(h),d[o].c(),y(d[o],1),d[o].m(t,null))}for(Q(),o=l.length;o<d.length;o+=1)f(o);ee()}},i(s){if(!r){for(let i=0;i<l.length;i+=1)y(d[i]);r=!0}},o(s){d=d.filter(Boolean);for(let i=0;i<d.length;i+=1)x(d[i]);r=!1},d(s){s&&G(t),J(d,s)}}}function ke(e,t,n){let a=[],r=[],l=[];return he(d=>{a=[...JSON.parse(Te)],a.sort((s,i)=>new Date(i.date)-new Date(s.date)),a.forEach(s=>{s.date=new Date(s.date).toLocaleString("en-US",{timeZone:"America/New_York"});const i=s.date.split(",")[0];r[i]?r[i]=[s,...r[i]]:r[i]=[s]});let f=0;for(let s in r)n(0,l[f]=r[s],l),f++}),[l]}class Ze extends ae{constructor(t){super(),oe(this,t,ke,_e,F,{})}}new Ze({target:document.getElementById("app")});
