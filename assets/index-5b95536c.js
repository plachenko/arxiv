var ae=Object.defineProperty;var ie=(e,t,n)=>t in e?ae(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var O=(e,t,n)=>(ie(e,typeof t!="symbol"?t+"":t,n),n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function n(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(a){if(a.ep)return;a.ep=!0;const l=n(a);fetch(a.href,l)}})();function Z(){}function D(e){return e()}function L(){return Object.create(null)}function x(e){e.forEach(D)}function U(e){return typeof e=="function"}function F(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function re(e){return Object.keys(e).length===0}function m(e,t){e.appendChild(t)}function P(e,t,n){e.insertBefore(t,n||null)}function A(e){e.parentNode&&e.parentNode.removeChild(e)}function J(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}function g(e){return document.createElement(e)}function N(e){return document.createTextNode(e)}function S(){return N(" ")}function T(e,t,n){n==null?e.removeAttribute(t):e.getAttribute(t)!==n&&e.setAttribute(t,n)}function se(e){return Array.from(e.childNodes)}function K(e,t){t=""+t,e.data!==t&&(e.data=t)}let k;function _(e){k=e}function le(){if(!k)throw new Error("Function called outside component initialization");return k}function de(e){le().$$.on_mount.push(e)}const b=[],q=[];let I=[];const M=[],ue=Promise.resolve();let H=!1;function he(){H||(H=!0,ue.then(R))}function E(e){I.push(e)}const Y=new Set;let w=0;function R(){if(w!==0)return;const e=k;do{try{for(;w<b.length;){const t=b[w];w++,_(t),ce(t.$$)}}catch(t){throw b.length=0,w=0,t}for(_(null),b.length=0,w=0;q.length;)q.pop()();for(let t=0;t<I.length;t+=1){const n=I[t];Y.has(n)||(Y.add(n),n())}I.length=0}while(b.length);for(;M.length;)M.pop()();H=!1,Y.clear(),_(e)}function ce(e){if(e.fragment!==null){e.update(),x(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(E)}}function fe(e){const t=[],n=[];I.forEach(o=>e.indexOf(o)===-1?t.push(o):n.push(o)),n.forEach(o=>o()),I=t}const G=new Set;let v;function V(){v={r:0,c:[],p:v}}function Q(){v.r||x(v.c),v=v.p}function y(e,t){e&&e.i&&(G.delete(e),e.i(t))}function $(e,t,n,o){if(e&&e.o){if(G.has(e))return;G.add(e),v.c.push(()=>{G.delete(e),o&&(n&&e.d(1),o())}),e.o(t)}else o&&o()}function j(e){return(e==null?void 0:e.length)!==void 0?e:Array.from(e)}function pe(e){e&&e.c()}function ee(e,t,n){const{fragment:o,after_update:a}=e.$$;o&&o.m(t,n),E(()=>{const l=e.$$.on_mount.map(D).filter(U);e.$$.on_destroy?e.$$.on_destroy.push(...l):x(l),e.$$.on_mount=[]}),a.forEach(E)}function te(e,t){const n=e.$$;n.fragment!==null&&(fe(n.after_update),x(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function me(e,t){e.$$.dirty[0]===-1&&(b.push(e),he(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function ne(e,t,n,o,a,l,d,f=[-1]){const i=k;_(e);const r=e.$$={fragment:null,ctx:[],props:l,update:Z,not_equal:a,bound:L(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(i?i.$$.context:[])),callbacks:L(),dirty:f,skip_bound:!1,root:t.target||i.$$.root};d&&d(r.root);let s=!1;if(r.ctx=n?n(e,t.props||{},(p,u,...c)=>{const h=c.length?c[0]:u;return r.ctx&&a(r.ctx[p],r.ctx[p]=h)&&(!r.skip_bound&&r.bound[p]&&r.bound[p](h),s&&me(e,p)),u}):[],r.update(),s=!0,x(r.before_update),r.fragment=o?o(r.ctx):!1,t.target){if(t.hydrate){const p=se(t.target);r.fragment&&r.fragment.l(p),p.forEach(A)}else r.fragment&&r.fragment.c();t.intro&&y(e.$$.fragment),ee(e,t.target,t.anchor),R()}_(i)}class oe{constructor(){O(this,"$$");O(this,"$$set")}$destroy(){te(this,1),this.$destroy=Z}$on(t,n){if(!U(n))return Z;const o=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return o.push(n),()=>{const a=o.indexOf(n);a!==-1&&o.splice(a,1)}}$set(t){this.$$set&&!re(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const ge="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(ge);function ye(e){let t,n,o,a,l=e[0].post+"",d,f;return{c(){t=g("div"),n=g("div"),n.textContent=`${e[1]}`,o=S(),a=g("div"),d=N(l),T(n,"class","date svelte-1q72qb8"),T(t,"class",f="post "+(e[0].thread?"thread":"")+" svelte-1q72qb8")},m(i,r){P(i,t,r),m(t,n),m(t,o),m(t,a),m(a,d)},p(i,[r]){r&1&&l!==(l=i[0].post+"")&&K(d,l),r&1&&f!==(f="post "+(i[0].thread?"thread":"")+" svelte-1q72qb8")&&T(t,"class",f)},i:Z,o:Z,d(i){i&&A(t)}}}function ve(e,t,n){let{post:o}=t,a=new Intl.DateTimeFormat("en-US",{timeStyle:"short"}).format(new Date(o.date));return e.$$set=l=>{"post"in l&&n(0,o=l.post)},[o,a]}class we extends oe{constructor(t){super(),ne(this,t,ve,ye,F,{post:0})}}const be=`[
    {
...
`;function X(e,t,n){const o=e.slice();return o[3]=t[n],o}function z(e,t,n){const o=e.slice();return o[6]=t[n],o}function W(e){let t,n;return t=new we({props:{post:e[6]}}),{c(){pe(t.$$.fragment)},m(o,a){ee(t,o,a),n=!0},p(o,a){const l={};a&1&&(l.post=o[6]),t.$set(l)},i(o){n||(y(t.$$.fragment,o),n=!0)},o(o){$(t.$$.fragment,o),n=!1},d(o){te(t,o)}}}function C(e){let t,n,o,a=e[3][0].date.split(",")[0]+"",l,d,f,i,r=j(e[3]),s=[];for(let u=0;u<r.length;u+=1)s[u]=W(z(e,r,u));const p=u=>$(s[u],1,1,()=>{s[u]=null});return{c(){t=g("div"),n=g("div"),o=g("span"),l=N(a),d=S();for(let u=0;u<s.length;u+=1)s[u].c();f=S(),T(o,"class","svelte-z157bo"),T(n,"class","dateGroup svelte-z157bo")},m(u,c){P(u,t,c),m(t,n),m(n,o),m(o,l),m(t,d);for(let h=0;h<s.length;h+=1)s[h]&&s[h].m(t,null);m(t,f),i=!0},p(u,c){if((!i||c&1)&&a!==(a=u[3][0].date.split(",")[0]+"")&&K(l,a),c&1){r=j(u[3]);let h;for(h=0;h<r.length;h+=1){const B=z(u,r,h);s[h]?(s[h].p(B,c),y(s[h],1)):(s[h]=W(B),s[h].c(),y(s[h],1),s[h].m(t,f))}for(V(),h=r.length;h<s.length;h+=1)p(h);Q()}},i(u){if(!i){for(let c=0;c<r.length;c+=1)y(s[c]);i=!0}},o(u){s=s.filter(Boolean);for(let c=0;c<s.length;c+=1)$(s[c]);i=!1},d(u){u&&A(t),J(s,u)}}}function Ie(e){let t,n,o,a,l=j(e[0].reverse()),d=[];for(let i=0;i<l.length;i+=1)d[i]=C(X(e,l,i));const f=i=>$(d[i],1,1,()=>{d[i]=null});return{c(){t=g("main"),n=g("h1"),n.innerHTML='ar<span id="x" class="svelte-z157bo">X</span>iv',o=S();for(let i=0;i<d.length;i+=1)d[i].c()},m(i,r){P(i,t,r),m(t,n),m(t,o);for(let s=0;s<d.length;s+=1)d[s]&&d[s].m(t,null);a=!0},p(i,[r]){if(r&1){l=j(i[0].reverse());let s;for(s=0;s<l.length;s+=1){const p=X(i,l,s);d[s]?(d[s].p(p,r),y(d[s],1)):(d[s]=C(p),d[s].c(),y(d[s],1),d[s].m(t,null))}for(V(),s=l.length;s<d.length;s+=1)f(s);Q()}},i(i){if(!a){for(let r=0;r<l.length;r+=1)y(d[r]);a=!0}},o(i){d=d.filter(Boolean);for(let r=0;r<d.length;r+=1)$(d[r]);a=!1},d(i){i&&A(t),J(d,i)}}}function Te(e,t,n){let o=[],a=[],l=[];return de(d=>{o=[...JSON.parse(be)],o.forEach(i=>{i.date=new Date(i.date).toLocaleString("en-US",{timeZone:"America/New_York"});const r=i.date.split(",")[0];a[r]?a[r]=[i,...a[r]]:a[r]=[i]});let f=0;for(let i in a)n(0,l[f]=a[i],l),f++}),[l]}class _e extends oe{constructor(t){super(),ne(this,t,Te,Ie,F,{})}}new _e({target:document.getElementById("app")});
