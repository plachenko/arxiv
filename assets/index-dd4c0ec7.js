var ue=Object.defineProperty;var he=(e,t,n)=>t in e?ue(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var N=(e,t,n)=>(he(e,typeof t!="symbol"?t+"":t,n),n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const h of o)if(h.type==="childList")for(const d of h.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function n(o){const h={};return o.integrity&&(h.integrity=o.integrity),o.referrerPolicy&&(h.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?h.credentials="include":o.crossOrigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function a(o){if(o.ep)return;o.ep=!0;const h=n(o);fetch(o.href,h)}})();function I(){}function ee(e){return e()}function U(){return Object.create(null)}function E(e){e.forEach(ee)}function te(e){return typeof e=="function"}function ne(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function ce(e){return Object.keys(e).length===0}function m(e,t){e.appendChild(t)}function A(e,t,n){e.insertBefore(t,n||null)}function k(e){e.parentNode&&e.parentNode.removeChild(e)}function oe(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}function y(e){return document.createElement(e)}function G(e){return document.createTextNode(e)}function S(){return G(" ")}function fe(){return G("")}function ae(e,t,n,a){return e.addEventListener(t,n,a),()=>e.removeEventListener(t,n,a)}function v(e,t,n){n==null?e.removeAttribute(t):e.getAttribute(t)!==n&&e.setAttribute(t,n)}function pe(e){return Array.from(e.childNodes)}function X(e,t){t=""+t,e.data!==t&&(e.data=t)}let q;function O(e){q=e}function me(){if(!q)throw new Error("Function called outside component initialization");return q}function ge(e){me().$$.on_mount.push(e)}const x=[],R=[];let j=[];const z=[],ye=Promise.resolve();let M=!1;function ve(){M||(M=!0,ye.then(ie))}function B(e){j.push(e)}const P=new Set;let $=0;function ie(){if($!==0)return;const e=q;do{try{for(;$<x.length;){const t=x[$];$++,O(t),we(t.$$)}}catch(t){throw x.length=0,$=0,t}for(O(null),x.length=0,$=0;R.length;)R.pop()();for(let t=0;t<j.length;t+=1){const n=j[t];P.has(n)||(P.add(n),n())}j.length=0}while(x.length);for(;z.length;)z.pop()();M=!1,P.clear(),O(e)}function we(e){if(e.fragment!==null){e.update(),E(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(B)}}function be(e){const t=[],n=[];j.forEach(a=>e.indexOf(a)===-1?t.push(a):n.push(a)),n.forEach(a=>a()),j=t}const H=new Set;let T;function C(){T={r:0,c:[],p:T}}function D(){T.r||E(T.c),T=T.p}function b(e,t){e&&e.i&&(H.delete(e),e.i(t))}function _(e,t,n,a){if(e&&e.o){if(H.has(e))return;H.add(e),T.c.push(()=>{H.delete(e),a&&(n&&e.d(1),a())}),e.o(t)}else a&&a()}function Y(e){return(e==null?void 0:e.length)!==void 0?e:Array.from(e)}function Ie(e){e&&e.c()}function se(e,t,n){const{fragment:a,after_update:o}=e.$$;a&&a.m(t,n),B(()=>{const h=e.$$.on_mount.map(ee).filter(te);e.$$.on_destroy?e.$$.on_destroy.push(...h):E(h),e.$$.on_mount=[]}),o.forEach(B)}function re(e,t){const n=e.$$;n.fragment!==null&&(be(n.after_update),E(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function Te(e,t){e.$$.dirty[0]===-1&&(x.push(e),ve(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function le(e,t,n,a,o,h,d,c=[-1]){const u=q;O(e);const l=e.$$={fragment:null,ctx:[],props:h,update:I,not_equal:o,bound:U(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(u?u.$$.context:[])),callbacks:U(),dirty:c,skip_bound:!1,root:t.target||u.$$.root};d&&d(l.root);let i=!1;if(l.ctx=n?n(e,t.props||{},(s,r,...p)=>{const f=p.length?p[0]:r;return l.ctx&&o(l.ctx[s],l.ctx[s]=f)&&(!l.skip_bound&&l.bound[s]&&l.bound[s](f),i&&Te(e,s)),r}):[],l.update(),i=!0,E(l.before_update),l.fragment=a?a(l.ctx):!1,t.target){if(t.hydrate){const s=pe(t.target);l.fragment&&l.fragment.l(s),s.forEach(k)}else l.fragment&&l.fragment.c();t.intro&&b(e.$$.fragment),se(e,t.target,t.anchor),ie()}O(u)}class de{constructor(){N(this,"$$");N(this,"$$set")}$destroy(){re(this,1),this.$destroy=I}$on(t,n){if(!te(n))return I;const a=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return a.push(n),()=>{const o=a.indexOf(n);o!==-1&&a.splice(o,1)}}$set(t){this.$$set&&!ce(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const _e="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(_e);function F(e){let t;return{c(){t=y("span"),t.textContent="(click to show)",v(t,"id","showTxt"),v(t,"class","svelte-1tudgk9")},m(n,a){A(n,t,a)},d(n){n&&k(t)}}}function ke(e){let t,n,a,o,h,d,c,u,l,i=!e[2]&&F();return{c(){t=y("div"),n=y("div"),n.textContent=`${e[4]}`,a=S(),o=y("div"),h=G(e[3]),d=S(),i&&i.c(),v(n,"class","date svelte-1tudgk9"),v(t,"class",c="post "+(e[0].thread=="cont"&&e[1]?"thread":"")+" "+(e[0].thread=="end"?"endThread":"")+" "+(e[0].thread=="start"?"startThread":"")+" svelte-1tudgk9")},m(s,r){A(s,t,r),m(t,n),m(t,a),m(t,o),m(o,h),m(o,d),i&&i.m(o,null),u||(l=ae(t,"click",e[5]),u=!0)},p(s,[r]){r&8&&X(h,s[3]),s[2]?i&&(i.d(1),i=null):i||(i=F(),i.c(),i.m(o,null)),r&3&&c!==(c="post "+(s[0].thread=="cont"&&s[1]?"thread":"")+" "+(s[0].thread=="end"?"endThread":"")+" "+(s[0].thread=="start"?"startThread":"")+" svelte-1tudgk9")&&v(t,"class",c)},i:I,o:I,d(s){s&&k(t),i&&i.d(),u=!1,l()}}}function Ze(e,t,n){let{post:a}=t,{idx:o}=t,h=new Intl.DateTimeFormat("en-US",{timeStyle:"short"}).format(new Date(a.date)),d=!1,u=a.post.split(" ").map(i=>{let s="blah".split("").map(r=>Math.floor(Math.random()*20)>10?r.toUpperCase():r).join("");for(let r=0;r<Math.floor(i.length/4);r++)s+=s;return i.includes("...")?s+"...":i.includes(".")?s+".":i.includes("?")?s+"?":i.includes(",")?s+",":i.includes("!")?s+"!":s}).join(" ");function l(){n(3,u=a.post),n(2,d=!0)}return e.$$set=i=>{"post"in i&&n(0,a=i.post),"idx"in i&&n(1,o=i.idx)},[a,o,d,u,h,l]}class $e extends de{constructor(t){super(),le(this,t,Ze,ke,ne,{post:0,idx:1})}}const xe=`[
    {
...
`;function J(e,t,n){const a=e.slice();return a[6]=t[n],a}function K(e,t,n){const a=e.slice();return a[9]=t[n],a[11]=n,a}function je(e){let t,n,a=Y(e[0].reverse()),o=[];for(let d=0;d<a.length;d+=1)o[d]=Q(J(e,a,d));const h=d=>_(o[d],1,1,()=>{o[d]=null});return{c(){for(let d=0;d<o.length;d+=1)o[d].c();t=fe()},m(d,c){for(let u=0;u<o.length;u+=1)o[u]&&o[u].m(d,c);A(d,t,c),n=!0},p(d,c){if(c&1){a=Y(d[0].reverse());let u;for(u=0;u<a.length;u+=1){const l=J(d,a,u);o[u]?(o[u].p(l,c),b(o[u],1)):(o[u]=Q(l),o[u].c(),b(o[u],1),o[u].m(t.parentNode,t))}for(C(),u=a.length;u<o.length;u+=1)h(u);D()}},i(d){if(!n){for(let c=0;c<a.length;c+=1)b(o[c]);n=!0}},o(d){o=o.filter(Boolean);for(let c=0;c<o.length;c+=1)_(o[c]);n=!1},d(d){d&&k(t),oe(o,d)}}}function Ge(e){let t;return{c(){t=y("div"),t.innerHTML=`<p class="svelte-1e4tqs8">This is an archive of a few old X (twitter) posts I made as <a href="https://www.twitter.com/dennylovesthis" class="svelte-1e4tqs8">@dennylovesthis</a></p> <p class="svelte-1e4tqs8">I&#39;ve archived them for personal retrieval but I don&#39;t feel as if any of
        ...
        action is all there is.</p> <p class="svelte-1e4tqs8">The source code to this site can be found <a href="https://www.github.com/plachenko/arxiv" class="svelte-1e4tqs8">here</a>
        and the script I used to scrape old timeline posts (text only) can be found
        <a href="https://gist.github.com/plachenko/4a41777914699704a98ea47b3964099b" class="svelte-1e4tqs8">here</a></p> <p class="svelte-1e4tqs8">Thank you for reading these and I hope you have a great day!</p>`,v(t,"id","modal"),v(t,"class","svelte-1e4tqs8")},m(n,a){A(n,t,a)},p:I,i:I,o:I,d(n){n&&k(t)}}}function V(e){let t,n;return t=new $e({props:{idx:e[11],post:e[9]}}),{c(){Ie(t.$$.fragment)},m(a,o){se(t,a,o),n=!0},p(a,o){const h={};o&1&&(h.post=a[9]),t.$set(h)},i(a){n||(b(t.$$.fragment,a),n=!0)},o(a){_(t.$$.fragment,a),n=!1},d(a){re(t,a)}}}function Q(e){let t,n,a,o=e[6][0].date.split(",")[0]+"",h,d,c,u,l=Y(e[6]),i=[];for(let r=0;r<l.length;r+=1)i[r]=V(K(e,l,r));const s=r=>_(i[r],1,1,()=>{i[r]=null});return{c(){t=y("div"),n=y("div"),a=y("span"),h=G(o),d=S();for(let r=0;r<i.length;r+=1)i[r].c();c=S(),v(a,"class","svelte-1e4tqs8"),v(n,"class","dateGroup svelte-1e4tqs8")},m(r,p){A(r,t,p),m(t,n),m(n,a),m(a,h),m(t,d);for(let f=0;f<i.length;f+=1)i[f]&&i[f].m(t,null);m(t,c),u=!0},p(r,p){if((!u||p&1)&&o!==(o=r[6][0].date.split(",")[0]+"")&&X(h,o),p&1){l=Y(r[6]);let f;for(f=0;f<l.length;f+=1){const w=K(r,l,f);i[f]?(i[f].p(w,p),b(i[f],1)):(i[f]=V(w),i[f].c(),b(i[f],1),i[f].m(t,c))}for(C(),f=l.length;f<i.length;f+=1)s(f);D()}},i(r){if(!u){for(let p=0;p<l.length;p+=1)b(i[p]);u=!0}},o(r){i=i.filter(Boolean);for(let p=0;p<i.length;p+=1)_(i[p]);u=!1},d(r){r&&k(t),oe(i,r)}}}function Se(e){let t,n,a,o,h,d,c,u,l,i,s,r,p;const f=[Ge,je],w=[];function W(g,Z){return g[2]?0:1}return l=W(e),i=w[l]=f[l](e),{c(){t=y("main"),n=y("h1"),n.innerHTML='ar<span id="x" class="svelte-1e4tqs8">X</span>iv',a=S(),o=y("span"),h=y("span"),d=G(e[1]),c=G(" characters thrown to a void -- what is happening!?"),u=S(),i.c(),v(h,"class","svelte-1e4tqs8"),v(o,"id","void"),v(o,"class","svelte-1e4tqs8")},m(g,Z){A(g,t,Z),m(t,n),m(t,a),m(t,o),m(o,h),m(h,d),m(o,c),m(t,u),w[l].m(t,null),s=!0,r||(p=ae(o,"click",e[3]),r=!0)},p(g,[Z]){(!s||Z&2)&&X(d,g[1]);let L=l;l=W(g),l===L?w[l].p(g,Z):(C(),_(w[L],1,1,()=>{w[L]=null}),D(),i=w[l],i?i.p(g,Z):(i=w[l]=f[l](g),i.c()),b(i,1),i.m(t,null))},i(g){s||(b(i),s=!0)},o(g){_(i),s=!1},d(g){g&&k(t),w[l].d(),r=!1,p()}}}function Ae(e,t,n){let a=[],o=[],h=[],d=0,c=!1;ge(l=>{a=[...JSON.parse(xe)],a.sort((s,r)=>new Date(r.date)-new Date(s.date)),a.forEach(s=>{s.date=new Date(s.date).toLocaleString("en-US",{timeZone:"America/New_York"}),n(1,d+=s.post.length);const r=s.date.split(",")[0];o[r]?o[r]=[s,...o[r]]:o[r]=[s]});let i=0;for(let s in o)n(0,h[i]=o[s],h),i++});function u(){n(2,c=!c)}return[h,d,c,u]}class Oe extends de{constructor(t){super(),le(this,t,Ae,Se,ne,{})}}new Oe({target:document.getElementById("app")});
